...
const Landing = () => {
    useEffect(() => {
        const snapFunction = () => {
          ...
          if (final <= 0.005) {  // Adjusted from 0.01 to 0.005
          ...
          } else if (final > 0.005 && final <= 0.015) {  // Adjusted from 0.01 to 0.015
          ...
          } else if (final > 0.015 && final <= 0.025) {  // Adjusted from 0.025 to 0.030
          ...
          } else if (final > 0.025 && final <= 0.035) {  // Adjusted from 0.045 to 0.045
          ...
          } else if (final > 0.035 && final <= 0.045) {  // Adjusted from 0.065 to 0.065
